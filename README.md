...
Это Flask-приложение с собственной системой управления доступом. Никаких готовых решений типа Flask-Login - все написано с нуля, чтобы показать, как работает аутентификация и авторизация изнутри.
